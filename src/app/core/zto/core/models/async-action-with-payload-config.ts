...
export class AsyncActionWithPayloadConfig<ThisState, ThisActionSchema extends ActionSchema<any, any, true, true>> extends ActionConfig<ThisState, ThisActionSchema> {
    constructor(
        type: string,
        reducer: {
        ...
        super(type, reducer as any, staticHeaders as any, true, true);
    }
}
